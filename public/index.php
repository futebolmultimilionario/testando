...
$requisicao = array(
	"messages"=>array(
			0=>array(
				...
				"body"=>"Tip148: PalmeiraRN ml @1.66⚽️min 1.57⚽️potiguar ⚽️",
				"fromMe"=>0,
				"self"=>0,
				"isForwarded"=>0,
...
function funcaoWR($mensagem){
	$parser = new aymanrb\UnstructuredTextParser\TextParser('../vendor/aymanrb/php-unstructured-text-parser/examples/templatesW');
	//Mudar para diretório referente ao GitHub!!!!
	$textToParse = preg_replace("/^[ \t]*[\r\n]+/m", "", strtolower($mensagem));
	$parseResults = $parser->parseText($textToParse, true)->getParsedRawData();
